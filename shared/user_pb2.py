...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_USERRESPONSE']._serialized_end=74
  _globals['_USERSERVICE']._serialized_start=76
  _globals['_USERSERVICE']._serialized_end=129
